...
func listInputOpts() mcp.ToolOption {
	return mcp.Input(
		mcp.Property("namespace",
			mcp.Description("Which namespace to use"),
		),
		mcp.Property("labelSelector",
			mcp.Description("Label selector to filter"),
		),
		mcp.Property("prefix",
			mcp.Description("Name prefix to filter"),
		),
	)
}
